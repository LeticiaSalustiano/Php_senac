...
<body>
  <nav class="navbar navbar-dark bg-dark">
    ...
    <ul class="navbar-nav">
      <li class="nav-item">
        <a class="nav-link" href="editar.php">VOLTAR</a>
      </li>
    </ul>
  </nav>
            ...
            <div class="row">
              <div class="col">
                <form action="conf_edit_chamado.php" method="POST">
                  ...
                  <div class="row mt-5">
                    <div class="col-6">
                      <a class="btn btn-lg btn-warning btn-block" href="editar.php">Cancelar</a>
                    </div>

                    <div class="col-6">
                      <button class="btn btn-lg btn-info btn-block" type="submit" onclick="alert('Editado com sucesso!')" href="editar.php">Salvar</button>
                    </div>
                  </div>
                </form>
              </div>
